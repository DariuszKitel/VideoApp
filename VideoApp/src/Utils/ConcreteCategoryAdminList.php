...
class ConcreteCategoryAdminList extends CategoryAbstract
{
    ...
    function getCategoryList(array $categories_array)
    {
        ...
        foreach ($categories_array as $value) {
            ...
            $this->categorylist .= $this->html_2 . $value['name'] . $this->html_3 . $url_edit . $this->html_4 .
